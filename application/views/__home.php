    ...
    <section class="features" id="features">
      <div class="container">
        <div class="section-heading text-center">
          <h2>Grow Beard for a Cause! #karma</h2>
          <p class="text-muted">Get a chance to be the "Beard Yogi" Of your locality </p>
          <hr>
        </div>
        <div class="row">
              ...
              <div class="row">
                <div class="col-lg-6">
                  <div class="feature-item">
                    ...
                    <p class="text-muted">Every month we host a Beard Campaign.You can also join campaigns in which you are interested</p>
                  </div>
                </div>
                <div class="col-lg-6">
                  <div class="feature-item">
                    ...
                    <p class="text-muted">Upload your selfies. Beard Yogi will track your progress</p>
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col-lg-6">
                  <div class="feature-item">
                    ...
                    <p class="text-muted">People around this world will rate your Beard's hotness.
                ...
                <div class="col-lg-6">
                  <div class="feature-item">
                    ...
                    <p class="text-muted">Win Sponsored Prizes. You would be rewarded a Beard Badge, say "#BeardGuru", etc. </p>
                  </div>
                </div>
              </div>
            </div>
